			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="panel-body">
						<h1 class="center">Affectation des encdrants académiques</h1><br><button class="btn btn-default"><a href="listeEncadrement">  Afficher la liste d'encadrement</a></button>
						<br><br>
						<div class="row">
							<div class="col-md-6">
            ...
            ?>
						...
						<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Liste des étudiants</h2>
									</header>
									<div class="panel-body">
							...
							<div class="col-md-6">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Liste des encadrants académiques</h2>
									</header>
									<div class="panel-body">
										<div class="table-responsive">
                                    <table class="table mb-none">
