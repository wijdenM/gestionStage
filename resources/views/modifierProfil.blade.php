							...
							<div class="tabs">
								...
								<div >
									...
									<div id="edit" class="tab-pane">
										...
										<form class="form-horizontal" method="post" action="modifierProfil">
											@csrf
											...
											<fieldset>
												<div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" value="{{$data['nomadmin']}}" class="form-control" name="nom">
														<input type="hidden" name="id" value={{$data['idadmin']}} >
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileLastName">Prenom</label>
													<div class="col-md-8">
														<input type="text" value="{{$data['prenomadmin']}}"class="form-control" name="pnom">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileAddress">Post</label>
													<div class="col-md-8">
														 <select name="post" class="form-control">
														 	<option value="{{$data['idpost']}}">{{$data['post']}}</option>
