					...
					<div class="panel-body">
						<a href="listeetudiant">
								...
								<div class="panel-body">
									<div class="thumb-info mb-md">
										<img src=images/{{$data['photo']}} class="rounded img-responsive" alt="John Doe">
											...
											<td><h4><strong>Id</strong></h4> <td><input type=text class="form-control input-lg" name="id" value="{{$data['idetudiant']}}"></td>
											<tr>
											<td ><h4><strong>Numéro CIN</strong></h4><td><input type=text class="form-control input-lg"value="{{$data['CIN']}}" name="cin">
											</td>
											<tr>
											<tr>
											<td ><h4><strong>Numéro  déinscription</strong></h4><td><input type=text class="form-control input-lg" value="{{$data['numinscrit']}}" name="incrit">
											</td>
											<tr>
											<tr>
											<td ><h4><strong>Nom</strong></h4><td><input type=text class="form-control input-lg" value="{{$data['nometudiant']}}" name="nom">
											</td>
											<tr>
											<td><h4><strong>prenom</strong> </h4><td><input type =text class="form-control input-lg" name="pnom" value="{{$data['prenometudiant']}}"></td>

											<tr>
											<td><h4><strong>Filiere</strong></h4> <td><select name="filiere" class="form-control">	<option value="{{$data['idfiliere']}}">{{$data['idfiliere']}}</option>
														 	<option value="1">Informatique de gestion</option>
														 	<option value="2">Science économique</option>
														 	<option value="3">Gestion</option>
														 </select></td>

											<tr>
												<tr>
											<td><h4><strong>Niveau</strong></h4> <td><select name="niveau" class="form-control">	<option value="{{$data['niveau']}}">{{$data['niveau']}}</option>
														 	<option >1ère Licence</option>
														 	<option >2ème Licence</option>
														 	<option >3ème Licence</option>
														 	<option >1ème Master</option>
														 	<option >2ème Master</option>
														 </select></td>
							...
							<table>
							     	<tr>
							     		<td>
							     <form action="desactiverEtudiant" method="post">
												@csrf
												<input type="hidden" value="{{$data['idetudiant']}}" name="id">

												<input type="submit" value="Désactiver"  class="btn btn-danger hidden-xs">
								</form>
							</td>
							<td>
								<form action="activerEtudiant" method="post">
												@csrf
												<input type="hidden" value="{{$data['idetudiant']}}" name="id">
