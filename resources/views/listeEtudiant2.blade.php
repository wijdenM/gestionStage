...
<html class="fixed">
	<head>
		...
		<title>Espace Encadrant Académique</title>
	...
	<body>
		<section class="body">
            ...
            <h1 class="center">Affecter les membres de jury</h1><br><br>
										...
										<tr class="gradeX">
											...
											<td class="actions">
												...
												<select name="jury" class="form-control">
								 	            @foreach($j as $j)
								 	            <option value="{{$j->idenseignant}}">{{$j->nomenseignant}} {{$j->prenomenseignant}}
								 	            </option>
								                 @endforeach
														 </select></td>
