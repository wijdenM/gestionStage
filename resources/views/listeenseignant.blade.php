					...
					<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="mb-md">
											<a href="fienseignant">									
											<button id="addToTable" class="btn btn-primary"> Importer <i class="fa fa-plus"></i></button></a>
										</form>
										</div>
									</div>
									<div class="col-sm-6">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<form action="modifierenseignant" method="get">
											
											<td>{{$enseignant['idenseignant']}}	<input type="hidden" value="{{$enseignant['idenseignant']}}" name="id"></td>
											<td>{{$enseignant['nomenseignant']}}
											</td>
											<td>{{$enseignant['prenomenseignant']}}</td>
											<td>{{$enseignant['departement']}}</td>
											<td>{{$enseignant['etat']}}</td>
