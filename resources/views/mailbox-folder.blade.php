						...
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="folder">
								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											...
											?>
													<a href="mailbox-folder" class="menu-item active">Boîte de réception <span class="label label-primary text-normal pull-right"><?php
												echo $cmp;?>
											</span></span></a>
												</li>
							...
							<table class="table table-striped mb-none">
									...
									<tbody>
										...
										<tr class="gradeX">
											<form action="mailbox-msg" method="get">
