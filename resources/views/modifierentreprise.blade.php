					...
					<div class="panel-body">
						<a href="listeentreprise">
							<button id="addToTable" class="btn btn-black">  <i class="fa fa-angle-left"></i></button></a>
								...
								<form method="post" action="modifierentreprise2">
									@csrf
								    <table class="table table-bordered table-striped mb-none" id="datatable-editable">
								        ...
								        <div class="panel-body">
										    ...
										    <td>
											    ...
											    <tr>
											    <td><h4><strong>Raison Sociale</strong> </h4></td><td><input type =text class="form-control input-lg" name="RS" value="{{$data['raisonsocial']}}"></td>
											  
											     <tr>
											    <td ><h4><strong>Activité</strong></h4></td><td><input type=text class="form-control input-lg" value="{{$data['activite']}}" name="act">
											    </td>
											    <tr>
											    ...
											    <td ><h4><strong>Encadrants entreprises</strong></h4></td><td>  <select name="etat" class="form-control">
											    	@foreach($e as $e)
