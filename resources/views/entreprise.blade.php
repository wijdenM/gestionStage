			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="panel-body">
						...
						<form method="post" action="ajoutentreprise">
							@csrf
							<div class="form-group mb-lg">
								<label>Raison Sociale</label>
								<input name="RS" type="text" class="form-control input-lg" />
							</div>
							<div class="form-group mb-lg">
								<label>Activité</label>
								<input name="act" type="text" class="form-control input-lg" />
							</div>
							<div class="form-group mb-lg">
								<label>Localisation</label>
								<input name="local" type="text" class="form-control input-lg" />
							</div>
