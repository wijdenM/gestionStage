						...
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="compose">
								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											...
											?>
													<a href="mailbox-folder" class="menu-item active">Boite de récéption <span class="label label-primary text-normal pull-right"><?php
												echo $cmp;?></span></a>
												</li>
							...
							<div class="inner-body">
								...
								<div class="mailbox-compose">
									<h1>Votre message est bien envoyer!</h1><br>
