...
<html class="fixed">
	...
	<link href="http://fonts.googleapis.com/css?">
		...
		<!-- Web Fonts  -->
		<lifamily=Open+Sans:300,400,600,700,800|Shadows+Into+Light" rel="stylesheet" type="text/css">
	...
	<body>
        ...
        <h2 class="mb-4">
            Importer la listes des enseignants
        </h2>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="panel-body">
						...
						<div class="container mt-5 text-center">
        <h2 class="mb-4">
            Importer la listes des enseignant
        </h2>

        <form action="{{ route('file-importEnseignantinterface') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group mb-4" style="max-width: 500px; margin: 0 auto;">
                <div class="custom-file text-left">
                    <input type="file" name="file" class="custom-file-input" id="customFile">
