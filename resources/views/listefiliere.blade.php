			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Liste des filières</span></li>
							</ol>
					...
					<div class="panel-body">
						<h1 class="center">Liste des filières</h1><br>
						<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="filiere">
						...
						<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>{{$data['idfiliere']}}	<input type="hidden" value="{{$data['idfiliere']}}" name="id"></td>
											<td>{{$data['filiere']}}
											</td>
											...
											<td class="actions">
												...
												<a href={{"delete/".$data['idfiliere']}}><button class=" btn-danger">Supprimer</button> </a>
