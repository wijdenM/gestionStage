			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<h2>Fiche d'évaluation du stagiaire</h2>
					...
					<div class="panel-body">
						<a href="listestagiaire">
							<button id="addToTable" class="btn btn-black">  <i class="fa fa-angle-left"></i></button></a>
								...
								?>
								<strong class="center"><h1>Fiche d'évaluation du stagiaire</h1><br>
									<h4>année universitaire &nbsp;{{$an1}}/{{$an}}</h4></strong> <br><br>
									<h4>Nom de l'étudiant(e):<br><br>
										N° CIN:<br><br>
										Filière:<br><br>
										Thème de stage:<br><br>
								...
								<table class="table table-bordered table-striped mb-none ">
									<thead>
										<tr>
											<td ></td>
											<td class="center"><strong>EVALUATION DE 1 à 5</strong></td>
								...
								<br><br>
								<h4>Veuillez évaluer les différents éléments sur une échelle de 1 à 5. <br><br>
                                     ...
                                     <h5><b>Cette fichier est à mettre en annexe du rapport de stage</b></h5>
