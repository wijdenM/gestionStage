					...
					<div class="panel-body">
						...
						<form method="post" action="ajoutadministrateur">
							...
							<div class="form-group mb-lg">
								...
								<input name="cin" type="text" value="{{old('CIN')}}" class="form-control input-lg" />
							</div>
							<div class="form-group mb-lg">
								<label>Nom</label>
								...
								<label>post</label>
								 <select name="post" class="form-control">
								 	...
								 	<option value="1">Secrétaire général</option>
														 	<option value="2">Responsable de bureau de stage</option>
							...
							<div class="form-group mb-lg">
								...
								<input name="numtel" type="text" class="form-control input-lg" />
							</div>
							<div class="form-group mb-lg">
								<label>Photo</label>
