							...
							<section class="panel">
								<div class="panel-body">
									<div class="thumb-info mb-md">
										<img src=images/{{$data['photo']}} class="rounded img-responsive" alt="John Doe">
											...
											<td>
												<input type=text class="form-control input-lg" name="id" value="{{$data['idenseignant']}}"></td>
											
											<tr>
											<td ><h4><strong>Identifiant</strong></h4><td>
												<input type=text class="form-control input-lg" value="{{$data['numCNSS']}}" name="cnss"></td>
											<tr>
											<td><h4><strong>Nom</strong></h4><td>
												<input type=text class="form-control input-lg" value="{{$data['nomenseignant']}}" name="nom"></td>
											<tr>
											<td><h4><strong>prenom</strong> </h4><td>
												<input type =text class="form-control input-lg" name="pnom" value="{{$data['prenomenseignant']}}"></td>

											
											<tr>
											<td><h4><strong>Grade</strong> </h4><td>
												<input type =text class="form-control input-lg" name="grade" value="{{$data['grade']}}"></td>

											<tr>
												
											<td><h4><strong>Numéro de telephone</strong> </h4><td>
												<input type =text class="form-control input-lg" name="numtel" value="{{$data['numtel']}}"></td>

											<tr>
											<td><h4><strong>Departement</strong></h4> <td> 
												<select name="Departement" class="form-control">	<option value="{{$data['iddepartement']}}">{{$data['iddepartement']}}</option>
														 	<option value="1">Informatique général</option>
														 	<option value="2">Gestion</option>
														 	</td>

											<tr>
												<td><input type=hidden class="form-control input-lg" name="photo" value="{{$data['photo']}}"></td>
											<tr>	
											<td><h4><strong>email</strong></h4><td>
												<input type=text class="form-control input-lg" name="email" value="{{$data['email']}}"></td>
								...
								<br>
							     ...
							     <table>
							     	<tr>
							     		<td>
							     <form action="desactiverEnseignant" method="post">
												@csrf
												<input type="hidden" value="{{$data['idenseignant']}}" name="id">

												<input type="submit" value="Désactiver"  class="btn btn-danger hidden-xs">
								</form>
							</td>
							<td>
								<form action="activerEnseignant" method="post">
												@csrf
												<input type="hidden" value="{{$data['idenseignant']}}" name="id">

												<input type="submit" value="activer"  class="btn btn-success hidden-xs">
								</form>
							</td>
							    </tr>
								</table>
