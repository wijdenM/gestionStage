			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Liste des départements</span></li>
							</ol>
					...
					<div class="panel-body">
						<h1 class="center">Liste des départements</h1><br>
						<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="departement">
						...
						<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>{{$data['iddepartement']}}	<input type="hidden" value="{{$data['iddepartement']}}" name="id"></td>
											<td>{{$data['departement']}}
											</td>
											...
											<td class="actions">
												...
												<a href={{"delete/".$data['iddepartement']}}><button class="btn-danger">Supprimer</button> </a>
