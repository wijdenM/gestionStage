							...
							<button id="addToTable" class="btn btn-black">  <i class="fa fa-angle-left"></i></button></a>
								...
								<form method="post" action="modifieradmin">
									    ...
									    <tr class="gradeX">
									    	<div class="col-md-4 col-lg-3">
								                ...
								                <div class="panel-body">
											        ...
											        <td>
											            <input type=text class="form-control input-lg" name="id" value="{{$data['idadmin']}}"</td>
											        <tr>
											        <td><h4><strong>Numéro CIN</strong> </h4><td><input type =text class="form-control input-lg" name="cin" value="{{$data['CIN']}}"></td>
											    <tr>
											     <tr>
											    <td ><h4><strong>Nom</strong></h4><td><input type=text class="form-control input-lg" value="{{$data['nomadmin']}}" name="nom">
											    </td>
											    <tr>
											    <td><h4><strong>prenom</strong> </h4><td><input type =text class="form-control input-lg" name="pnom" value="{{$data['prenomadmin']}}"></td>

											    <tr>
											    <td><h4><strong>Post</strong></h4> <td>
											    	 <select name="post" class="form-control">	<option value="{{$data['idpost']}}">{{$data['idpost']}}</option>
														 	<option value="1">Secrétaire général</option>
														 	<option value="2">Directeur du stage</option>
							     ...
							     <table>
							     	<tr>
							     		<td>
							     <form action="desactiver" method="post">
												@csrf
												<input type="hidden" value="{{$data['idadmin']}}" name="id">
