...
<html class="fixed sidebar-left-collapsed">
	<head>
		...
		<title>Espace Encadrant Entreprise</title>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Messages envoyés</span></li>
							</ol>
						...
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="folder">
								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											...
											?>
													<a href="mailbox-folderEE" class="menu-item">Boîte de réception<span class="label label-primary text-normal pull-right"><?php
												echo $cmp;?></span></a>
												</li>
												
												<li>
													<a href="mailbox-folderEEenvoyer" class="menu-item active">Envoyés</a>
												</li>
							...
							<table class="table table-striped mb-none">
									...
									<tbody>
										...
										<tr class="gradeX">
											<form action="mailbox-msgEEenvoyer" method="get">
