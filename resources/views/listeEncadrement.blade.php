			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="panel-body">
						<a href="test">
							<button id="addToTable" class="btn btn-black">  <i class="fa fa-angle-left"></i></button></a><br><br>
						...
						<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>{{$data->e1}}&nbsp;{{$data->p1}}&nbsp;--{{$data->e2}}&nbsp;{{$data->p2}}
											</td>
											<td>{{$data->nomenseignant}}&nbsp;&nbsp;{{$data->prenomenseignant}}</td>
