				...
				<section role="main" class="content-body">
					...
					<div class="panel-body">
								<div class="row">
									...
									<div class="col-sm-6">
										<form action="/rechEntreprise" method="post">
											<div class="search">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<form action="detailEntreprise" method="get">
										<tr class="gradeX">
											
											
											<td>{{$entreprise['identreprise']}}	<input type="hidden" value="{{$entreprise['identreprise']}}" name="id"></td>
											<td>{{$entreprise['raisonsocial']}}
											</td>
