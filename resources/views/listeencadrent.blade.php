				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Encadrants entreprises</span></li>
							</ol>
					...
					<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										@foreach ($encadrantentreprise as $encadrantentreprise)
										<tr class="gradeX">
											<form action="modifierEE" method="get">
											
											<td>{{$encadrantentreprise['idencad']}}	<input type="hidden" value="{{$encadrantentreprise['idencad']}}" name="id"></td>
											<td>{{$encadrantentreprise['nomEncad']}}
											</td>
											<td>{{$encadrantentreprise['prenomEncad']}}
											</td>
											<td>{{$encadrantentreprise['societe']}}
											</td>
											<!--<td>{{$encadrantentreprise['numtel']}}
											</td>-->
											
											<!--<td><img src="images/{{$encadrantentreprise['photo']}}" height="50px"></td>-->
											<!--<td>{{$encadrantentreprise['email']}}</td>-->
											<td class="actions">
												
												<input type="submit" value="Afficher détails"  class="btn btn-info hidden-xs">
