						...
						<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td><input type="hidden" name="e1" value="{{$data->e1}}">{{$data->e1}}&nbsp;
												<input type="hidden" name="p1" value="{{$data->p1}}">{{$data->p1}}&nbsp;
												<input type="hidden" name="e2" value="{{$data->e2}}">--{{$data->e2}}&nbsp;
												<input type="hidden" name="p2" value="{{$data->p2}}">{{$data->p2}}
											</td>
											<td><input type="hidden" name="nenseignant" value="{{$data->nomenseignant}}">{{$data->nomenseignant}}&nbsp;&nbsp;<input type="hidden" name="penseignant" value="{{$data->prenomenseignant}}">{{$data->prenomenseignant}}</td>
