										...
										<form class="form-horizontal" method="post" action="">
											...
											<fieldset>
												<div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" value="{{$data['nometudiant']}}" class="form-control" name="nom">
															<input type="hidden" name="id" value="{{$data['idetudiant']}} ">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileLastName">Prenom</label>
													<div class="col-md-8">
														<input type="text" value="{{$data['prenometudiant']}}"class="form-control" name="pnom">
													</div>
												</div>
