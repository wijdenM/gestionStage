				...
				<section role="main" class="content-body">
					...
					<section class="content-with-menu mailbox">
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="folder">
								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											...
											?>
													<a href="mailbox-folder" class="menu-item">Boîte de réception <span class="label label-primary text-normal pull-right"><?php
												echo $cmp;?></span></a>
												</li>
												
												<li>
													<a href="mailbox-folderE" class="menu-item active">Envoyés</a>
												</li>
						    ...
						    <form method="post" action="mailbox-msgEnvoyer">
									@csrf
