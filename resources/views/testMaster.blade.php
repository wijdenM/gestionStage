			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="panel-body">
						<h1 class="center">Affectation des encdrants académiques</h1>
						<br><br>
						<div class="row">
							<div class="col-md-6">
						<section class="panel">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td> {{$pro->net1}} {{$pro->pet1}}</td>
											<td> {{$pro->net2}} {{$pro->pet1}}</td>
										<td> <button  class="btn btn-link"><i class="fa fa-check-square-o" aria-hidden="true"></i></button></td>
											<!--</form>-->
