...
<html class="fixed">
	...
	<body>
		<section class="body">
            ...
            ?>
            <h1 class="center">Autoriser les dépots</h1><br><br>
						<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>{{$data->idprojet}}	<input type="hidden" value="{{$data->idprojet}}" name="id"></td>
											<td>{{$data->sujet}}
											</td>
											<td>{{$data->net1}}&nbsp;{{$data->pet1}}</td>
											<td>{{$data->net2}}&nbsp;{{$data->pet2}}</td>
											
											
											<td class="actions">
												<?php 
											
												$resultat = mysqli_query($conn ,"select * from projet where idprojet=$data->idprojet and etat= 1");
												$nb=0;
												while($row=mysqli_fetch_array($resultat))
												{
													$nb++;
										...
										if ($nb > 0)
										{
											...
											?>
												...
												<input type="submit" value="Autoriser"  class="btn btn-info hidden-xs"></td>
