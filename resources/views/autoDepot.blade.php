			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="panel-body">
								...
								?>
								<strong class="center"><h1>Autorisation de dépôt</h1><br>
									<h4>année universitaire {{$an1}}/{{$an}}</h4></strong> <br><br>
									<h4>Nom de l'étudiant(e):<br><br>
									Spécialité:<br><br>
									Titre de stage: <br><br>
									Nom et Prénom de l'encadrant académique:<br><br>
								L'encadrant académique autorise le/la candidat(e) à déposer son rapport de stage</h4>
									 <br><br>
