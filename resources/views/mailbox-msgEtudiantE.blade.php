				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Message envoyé</span></li>
							</ol>
					...
					<section class="content-with-menu mailbox">
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="folder">
								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											...
											?>
													<a href="mailbox-folderEtudiant" class="menu-item ">Boîte de réception <span class="label label-primary text-normal pull-right"><?php
												echo $cmp;?></span></a>
												</li>
												
												<li>
													<a href="mailbox-folderEtudiantE" class="menu-item active">Envoyés</a>
												</li>
						    ...
						    <form method="get" action="mailbox-msgEtudiantE">
									@csrf
							    ...
							    <div class="inner-body mailbox-email">
								    <div class="mailbox-email-header mb-lg">
									   <h3 class="mailbox-email-subject m-none text-light">
									    ...
									    <p class="mt-lg mb-none text-md">From <a href="#">You</a> to <a href="#">Okler Themes</a></p>
								    </div>
										    ...
										    <div class="panel">
											    <div class="panel-heading">
												    <div class="panel-actions">
												       ...
												       <p class="panel-title">You <i class="fa fa-angle-right fa-fw"></i>Okler Themes </p>
											    </div>
